    ...
    public class UploadObjectTest
    {
        ...
        public void CalculatePerformanceMetricsWithoutCrc32C()
        {
            ...
            foreach (int sizeInBytes in blockSizes)
            {
                ...
                byte[] dataBufferInBytes = new byte[sizeInBytes];
                var dataBuffer = GenerateData(sizeInBytes);
        ...
        public void CalculatePerformanceMetricsWithCrc32c()
        {
            ...
            // --- Print Results Table ---
            PrintResultsWithUploadValidation(results);
        }

        private static void PrintResultsWithUploadValidation(List<BenchmarkResult> results)
        {
            Console.WriteLine("\n--- Benchmark Results for Upload with Data Validation ---");
        ...
        {
            Console.WriteLine("\n--- Benchmark Results for Upload without Data Validation ---");
